...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process, ReactDOM) {'use strict';
	...
	var _MenuTree = __webpack_require__(60);
	...
	var store = (0, _redux.createStore)(_MenuTree2.default, _redux.applyMiddleware.apply(undefined, middleware));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deepDiff = __webpack_require__(50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuTree = __webpack_require__(53);

	var _MenuTree2 = _interopRequireDefault(_MenuTree);

	var _IntuitiveTree = __webpack_require__(54);

	var _IntuitiveTree2 = _interopRequireDefault(_IntuitiveTree);

	var _MenuTree3 = __webpack_require__(55);

	var _MenuTree4 = _interopRequireDefault(_MenuTree3);

	var _IntuitiveTree3 = __webpack_require__(57);

	var _IntuitiveTree4 = _interopRequireDefault(_IntuitiveTree3);

	var _reactRedux = __webpack_require__(36);

	var _MenuTree5 = __webpack_require__(59);
	...
	var Main = function (_React$Component) {
	    ...
	    _createClass(Main, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var selectedNode = _props.selectedNode;

	            dispatch((0, _MenuTree5.fetchPostsIfNeeded)(selectedNode));
	        }
	    }, {
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            if (nextProps.selectedNode !== this.props.selectedNode) {
	                ...
	                var selectedNode = nextProps.selectedNode;
	...
	var mapStateToProps = function mapStateToProps(state) {
	    ...
	    var postsByNode = state.postsByNode;

	    var _ref = postsByNode[selectedNode] || {
	        isFetching: true,
	        items: []
	    };
	                ...
	                if (node.length > 1) {
	                    node.forEach(function (item) {
	                        temp.push(React.createElement(
	                            ...
	                            item.children && item.children.length > 1 ? React.createElement(
	                                "ul",
	                                null,
...
/***/ function(module, exports) {
	...
	var INVALIDATE_NODE = exports.INVALIDATE_NODE = 'INVALIDATE_NODE';

	var selectNode = exports.selectNode = function selectNode(node) {
	    return {
	        type: SELECT_NODE,
	        node: node
	    };
	...
	var invalidateNode = exports.invalidateNode = function invalidateNode(node) {
	    return {
	...
	var requestPosts = exports.requestPosts = function requestPosts(node) {
	    return {
	        type: REQUEST_POSTS,
	        node: node
	    };
	...
	var receivePosts = exports.receivePosts = function receivePosts(node, json) {
	    return {
	        type: RECEIVE_POSTS,
	        node: node,
	        posts: json.data,
	...
	var fetchPosts = function fetchPosts(node) {
	    return function (dispatch) {
	        dispatch(requestPosts(node));
	        return fetch('/treeList').then(function (response) {
	            return response.json();
	        }).then(function (json) {
	            return dispatch(receivePosts(node, json));
	        });
	    };
	};

	var shouldFetchPosts = function shouldFetchPosts(state, node) {
	    var posts = state.postsByNode[node];
	    if (!posts) {
	        return true;
	    }
	    if (posts.isFetching) {
	...
	var fetchPostsIfNeeded = exports.fetchPostsIfNeeded = function fetchPostsIfNeeded(node) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuTree = __webpack_require__(59);
	...
	var posts = function posts() {
	    ...
	    switch (action.type) {
	        case _MenuTree.INVALIDATE_NODE:
	            return _extends({}, state, {
	                didInvalidate: true
	            });
	        case _MenuTree.REQUEST_POSTS:
	            return _extends({}, state, {
	                isFetching: true,
	                didInvalidate: false
	            });
	        case _MenuTree.RECEIVE_POSTS:
	            return _extends({}, state, {
	                isFetching: false,
	                didInvalidate: false,
	                items: action.posts,
	...
	var postsByNode = function postsByNode() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
	    ...
	    switch (action.type) {
	        ...
	        case _MenuTree.RECEIVE_POSTS:
	        case _MenuTree.REQUEST_POSTS:
	            return _extends({}, state, _defineProperty({}, action.node, posts(state[action.node], action)));
	        default:
	            return state;
	    }
	};
