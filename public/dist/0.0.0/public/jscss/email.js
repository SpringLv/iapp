...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DoSearch = __webpack_require__(3);
	...
	ReactDOM.render(_react2.default.createElement(_DoSearch2.default, null), document.getElementById("reactDom"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DoSearch = function (_React$Component) {
	    _inherits(DoSearch, _React$Component);

	    function DoSearch(props) {
	        _classCallCheck(this, DoSearch);

	        var _this = _possibleConstructorReturn(this, (DoSearch.__proto__ || Object.getPrototypeOf(DoSearch)).call(this, props));

	        _this.state = {};
	        return _this;
	    }

	    _createClass(DoSearch, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'div',
	                { ref: 'doSearch', className: 'email-doSearch-box' },
	                React.createElement(_RecipientsList2.default, { ref: 'recipientsList', parentDom: this }),
	                React.createElement(_InputBox2.default, { ref: 'inputBox', parentDom: this }),
	                React.createElement(_SelectList2.default, { ref: 'selectList', parentDom: this })
	            );
	        }
	    }, {
	        key: 'InputBoxInput',
	        ...
	        key: 'EditItem',
	        value: function EditItem(item, index, state) {
	            if (!state) return;
	            var inputBox = this.refs.inputBox;
	            var recipientsList = this.refs.recipientsList;
	            var recipientsListState = recipientsList.state;
	            var list = recipientsListState.list;
	            if (state == "add") {
	                list.push(item);
	        ...
	        key: 'GetSelectList',
	        value: function GetSelectList(data, hook) {
	            var _this2 = this;

	            $.post('/emailList', { 'name': data }).then(function (res) {
	                var inputValue = _this2.refs.inputBox.state.inputValue;
	                if (res && res.data) {
	                    if (hook && !res.data.length) {
	                        inputValue = _this2.StringSub(inputValue);
	                        _this2.refs.inputBox.setState({ inputValue: inputValue });
	                        _this2.MoreKeysSearch(inputValue);
	                    }
	                    _this2.refs.selectList.setState({ list: res.data });
	                } else {}
	            });
	        }
	    }, {
	        key: 'MoreKeysSearch',
	        value: function MoreKeysSearch(keys) {
	            var k = keys.split(";");
	        ...
	        key: 'StringSub',
	        value: function StringSub(str) {
	            var k = str.substr(str.indexOf(";") + 1);
	            return k;
	        }
	    }]);
